...
pretrained = torch.load('/u/training/tra294/HW9/' + 'resnet-50-kinetics.pth')
#pretrained = torch.load('/u/training/tra294/HW9/' + 'resnet.pth')
...
for epoch in range(0,num_of_epochs):
    ...
    #test_acc_epoch.append(accuracy_test)
    #if test_acc_epoch[-1] < test_acc_epoch[-2]:
    #    break        
